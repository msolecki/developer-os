/**
 * `workflowContractSchema` is deliberately **not** exported, and Workflow architecture former §14's
 ...
 * Workflow architecture former §8 makes for overlays: a guarantee is better as a shape nothing can get
