...
- [ ] Before the pin is removed: move the release layout to Spec 2 §3.2 (D19, NEW-80), correct the V1 refusal's recovery (D20, NEW-79), and harden the ordinary-command gate (NEW-81).
