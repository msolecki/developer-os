...
- [x] **Step 1: Establish which contract is authoritative, from the documents**
...
- [x] **Step 2: Decide, and record the decision before touching code**
...
- [x] **Step 3: If option 1, write the failing test first**
...
- [x] **Step 4: If option 1, make `blocksNewIntent` load-bearing**
...
- [x] **Step 2: Say in the workflow what happens when the vendor is absent**
...
- [x] **Step 3: Reconcile the rest of the file against `package.json`**
...
- [x] **Step 4: Verify the YAML parses and the job graph is what you intended**
...
- [x] **Step 1: Write the failing test that counts inspections**
...
- [x] **Step 3: Thread the inspection**
...
- [x] **Step 4: Verify the count and that nothing regressed**
...
- [x] **Step 3: Memoize per inspection, not globally**
...
- [x] **Step 3: Group the walks and index the rows**
...
- [x] **Step 3: Call the store with an admission context**
...
- [x] **Step 1: Establish what each call site can honestly confine against**
...
- [x] **Step 4: Write `admission.ts` and adopt it at all three sites**
...
- [x] **Step 3: Decide about the timeouts, with the measurement in hand**
...
- [x] **Step 4: Record the numbers where they will be found**
