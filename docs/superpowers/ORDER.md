...
at `plans/2026-08-29-developer-os-release-update.md`. Spec 2 Task 1 completed 2026-08-29; the next
action is Spec 2 Task 2 at `docs/superpowers/plans/2026-08-29-developer-os-release-update.md:120`. Execute Tasks 2–9 first to
...
5. Now: execute Spec 2 Tasks 2–9 for the `InstallationManifestV2` migration and V2 new-init
   handoff.
...
- Active implementation plans: 49 untouched tasks — 25 in Spec 2 and 24 in Spec 1. Spec 2 Tasks
  2–9 are the active prerequisite; Spec 1 remains blocked until that handoff passes.
