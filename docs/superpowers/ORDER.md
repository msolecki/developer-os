...
2026-08-11. `plans/2026-07-21-developer-os-codex-adapter.md` is **17/19** as of 2026-08-12, each
...
install proposal, `codex exec`, and `CodexAdapter`. **`plugins/codex/` is generated and drift-gated as of
Task 14; `npm run render:codex` regenerates it.**
...
|---|---|---|---|:---:|---|---|
| A9 | DOS-P5 Codex adapter — S / P / I | `plans/2026-07-21-developer-os-codex-adapter.md`, 19 tasks | — | L | program plan Task 5 checkpoint: Claude-only, Codex-only and dual installs all work | **now** — `S` and `P` closed 2026-08-11; `I` is **17/19**, resume at Task 17 |
...
**Seven milestones remain**, each L: DOS-P5's implementation, which is 17 of its 19 tasks done;
