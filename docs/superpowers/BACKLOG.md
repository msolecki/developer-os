...
2026-08-12, and the third — DOS-P5's plan amending *itself* with a Task 3.5 — was decided the same
day, before the task it precedes was dispatched. All three are in the table below, each carrying
its outcome rather than its question.
