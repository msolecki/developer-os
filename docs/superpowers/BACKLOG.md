...
**One row is awaiting ratification and is the only unratified row in this section.** Raised by DOS-P6
Task 12 on 2026-08-14, during implementation rather than planning, which is why it is not in either
table above.
