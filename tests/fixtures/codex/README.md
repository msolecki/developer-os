...
0.147.0's output protocol only; whether it still describes 0.151.0 was settled by the source
comparison recorded immediately below and in `docs/architecture/vendor-invocation.md`.
